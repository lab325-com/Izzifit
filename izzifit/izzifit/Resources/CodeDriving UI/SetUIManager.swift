...
struct SetUIManager {
    ...
    func myFirstGenericFunc<T: UIView>(view: T,
                                       parentView: UIView,
                                       width: CGFloat? = nil,
                                       height: CGFloat? = nil,
                                       topC: CGFloat? = nil,
                                       ...
                                       trailingCG: CGFloat? = nil)
    {
        ...
        if topC != nil {
            view.topAnchor.constraint(equalTo: parentView.topAnchor, constant: topC!).isActive = true
        }
        if bottomC != nil {
            view.bottomAnchor.constraint(equalTo: parentView.bottomAnchor, constant: -bottomC!).isActive = true
        }
        if leadingC != nil {
            view.leadingAnchor.constraint(equalTo: parentView.leadingAnchor, constant: leadingC!).isActive = true
        }
        if trailingC != nil {
            view.trailingAnchor.constraint(equalTo: parentView.trailingAnchor, constant: -trailingC!).isActive = true
        }
        if centerV != nil {
            view.centerYAnchor.constraint(equalTo: parentView.centerYAnchor, constant: centerV!).isActive = true
        }
        if centerH != nil {
            view.centerXAnchor.constraint(equalTo: parentView.centerXAnchor, constant: centerH!).isActive = true
        }
        if centerVtoO != nil {
            view.centerYAnchor.constraint(equalTo: centerVtoO! as! NSLayoutAnchor<NSLayoutYAxisAnchor>).isActive = true
        }
        if centerHtoO != nil {
            view.centerXAnchor.constraint(equalTo: centerHtoO! as! NSLayoutAnchor<NSLayoutXAxisAnchor> ).isActive = true
        }
        if topToO != nil, topCG != nil {
            view.topAnchor.constraint(equalTo: topToO! as! NSLayoutAnchor<NSLayoutYAxisAnchor> , constant: topCG!).isActive = true
        }
        if bottomToO != nil, bottomCG != nil {
            view.bottomAnchor.constraint(equalTo: bottomToO! as! NSLayoutAnchor<NSLayoutYAxisAnchor> , constant: -bottomCG!).isActive = true
        }
        if leadingToO != nil, leadingCG != nil {
            view.leadingAnchor.constraint(equalTo: leadingToO! as! NSLayoutAnchor<NSLayoutXAxisAnchor>  , constant: leadingCG!).isActive = true
        }
        if trailingToO != nil, trailingCG != nil {
            view.trailingAnchor.constraint(equalTo: trailingToO! as! NSLayoutAnchor<NSLayoutXAxisAnchor>  , constant: -trailingCG!).isActive = true
        }
    }

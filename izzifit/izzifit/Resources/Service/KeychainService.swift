...
class KeychainService {
    ...
     
    func getValue(forKey key: Key, accessibility: KeychainItemAccessibility? = nil) -> String? {
        return self.wrapper.string(forKey: key.rawValue, withAccessibility: accessibility)
    }
    
    func seValueString(value: String, forKey key: Key) {
        self.wrapper.set(value, forKey: key.rawValue)
    }

...
class FranceLevelView: UIView {
    ...
    var cgRects: [CGRect]  = [CGRect(x: 58.3, y: 202.4, width: 151.8, height: 158.4),
                                             CGRect(x: 279.4, y: 251.9, width: 138.6, height: 152.9),
                                             CGRect(x: 69.3, y: 382.8, width: 154, height: 158.4),
                                             CGRect(x: 260.7, y: 502.7, width: 132, height: 160.6),
                                             CGRect(x: 83.6, y: 572, width: 171.6, height: 116.6)]
    ...
    private func setUI() {
        imgUponScroll.image = RImage.level_france_back() ?? UIImage()
